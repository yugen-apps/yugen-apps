...
public partial class MainViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    public partial List<CategoryObservableObject> GroupedProjects { get; set; } = [];
    ...
    partial void OnSelectedCategoryChanged(CategoryObservableObject value)
    {
        GroupedProjects = SelectedCategory.Projects
          .GroupBy(p => p.Org)
