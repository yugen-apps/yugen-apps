...
public partial class WebPreviewViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    public partial bool ErrorLoadingWebPreview
    {
        get; set;
    }
    ...
    [ObservableProperty]
    public partial bool IsWebPreviewLoading
    {
        get; set;
    }

    [ObservableProperty]
    public partial bool IsWebPreviewOpened
    {
        get; set;
    }
    ...
    public partial Uri WebPreviewSource
    {
        get;
        set;
    } = null;
    ...
    [ObservableProperty]
    public partial string WebTitle
    {
        get; set;
    }
    ...
    {
        try { await sender.ExecuteScriptAsync(KeydownBridgeJs); } catch { /* ignore */ }
    }
